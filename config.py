...
class Config(object):
    ...
    DB_URL  = os.environ.get("DB_URL","mongodb+srv://akre:akre@cluster0.gtpo3kw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

    # other configs
    BOT_UPTIME  = time.time()
    START_PIC   = os.environ.get("START_PIC", "https://envs.sh/jUp.jpg")
    ADMIN = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '7251898668').split()]

    # channels logs
    FORCE_SUB   = os.environ.get("FORCE_SUB", "Cineoriginals") 
...
💖 𝐔𝐏𝐈 𝐈𝐃 : `Contact Owner`

💗 JOIN BACK-UP : <b><a href='https://t.me/akmovieshubbackup'>𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾</a></b>
"""
