...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("♻ ᴅᴇᴠᴇʟᴏᴘᴇʀ ♻", url='https://telegram.me/The_SonGoku')]
    ])
    if Config.START_PIC:
...
async def cb_handler(client, query: CallbackQuery):
    ...
    if data == "start":
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview = True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("🤖 ᴍᴏʀᴇ ʙᴏᴛs", url="https://t.me/akmoviebotz/30")],
        ...
        if len(str(user_id)) == 10:
            ...
            try:
                await client.send_message(user_id , f"<b>ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ ʙʏ [Owner](https://telegram.me/The_SonGoku)\nʀᴇᴀsᴏɴ : {reason}</b>")
        ...
        if len(str(user_id)) == 10:
            try:
                unban_text = "<b>ʜᴜʀʀᴀʏ..ʏᴏᴜ ᴀʀᴇ ᴜɴʙᴀɴɴᴇᴅ ʙʏ [Owner](https://telegram.me/The_SonGoku)</b>"
